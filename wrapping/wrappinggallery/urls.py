...
from . import views
from .sitemaps import CarrySitemap, StaticViewSitemap
...
urlpatterns = [
    ...
    path(
        "achievement-file-url/<str:file_name>/",
        views.achievement_file_url,
        name="achievement_file_url",
    ),
    path("step-urls/<str:prefix>/", views.steps_url, name="file_url"),
    path("downloads/", views.downloads, name="downloads"),
    path(
        "download-booklet/<str:carry>", views.download_booklet, name="download_booklet"
    ),
    ...
    path("api/carry-count/", views.carry_count, name="carry-count"),
]
