    ...
    def handle(self, *args, **kwargs):
        ...
        for item in data:
            ...
            if achievement_qs.exists():
                ...
                if (achievement.title != item['title']) or \
                    (achievement.description != item['description']) or \
                    (achievement.category != item['category']) or \
                    ...
                    achievement.save()
                    self.stdout.write(self.style.SUCCESS(f'- Updated: {achievement.name}'))
                else:
        ...
        self.stdout.write(self.style.SUCCESS('Successfully loaded data into Achievement'))
